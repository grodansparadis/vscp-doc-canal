...
CANAL (CAN Abstraction Layer) is a very simple approach to interfacing a CAN module/card or some other CAN hardware. It is simple and consists mostly of open, close, read, write and filter/mask handling.
